...
public class Main {
    public static void main(String[] args) {
        ...
        //JPanel preparedPanel = new ScrollFrame(movieList);

        JScrollPane ourPanels = new ScrollFrame(movieList);
        mainFrame.getContentPane().add(ourPanels, BorderLayout.CENTER);
        ourPanels.setVisible(false);
