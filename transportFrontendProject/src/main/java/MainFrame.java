...
public class MainFrame extends JFrame {
    ...
    public MainFrame(){
        ...
        this.add(this.backPanel, BorderLayout.NORTH);
        ...
        this.startPage.getBook().addActionListener((e)-> {
            ...
            this.movieList.setMovieListFromBackend(gson.fromJson(movieListString,new TypeToken<ArrayList<JsonObject>>(){}.getType()));
